...
namespace DMA_PDL_v1_0.Utils
{
    ...
    public class CyDmaDescriptionProperties : CyProperties
    {
        ...
        public CyDmaDescriptionProperties()
        {
            ...
            NumberOfDataElementsToTransferX = CyConst.C_CATEGORY_LOOP_TRANSFER_DEF;
            ...
            NumberOfDataElementsToTransferY = CyConst.C_CATEGORY_LOOP_TRANSFER_DEF;
        ...
        [ReadOnly(false)]
        [PropertyOrder(1)]
        [XmlElement("NumberOfDataElementsToTransferX")]
        ...
        [CyPropertyId(CyEPropertyIdEnum.NumberOfDataElementsToTransferX)]
        public UInt16 NumberOfDataElementsToTransferX
        { get; set; }
        ...
        [ReadOnly(false)]
        [PropertyOrder(1)]
        [XmlElement("NumberOfDataElementsToTransferY")]
        [Description(CyTextConst.DESCRIPTION_NUMBER_OF_DATA_ELEMENTS_TO_TRANSFER)]
        [DefaultValue(CyConst.C_CATEGORY_LOOP_TRANSFER_DEF)]
        [Category(CyTextConst.CATEGORY_Y_LOOP_TRANSFER)]
        [DisplayName(CyTextConst.NUMBER_OF_DATA_ELEMENTS_TO_TRANSFER)]
        [CyPropertyId(CyEPropertyIdEnum.NumberOfDataElementsToTransferY)]
        public UInt16 NumberOfDataElementsToTransferY
        { get; set; }
        ...
        protected override PropertyDescriptorCollection FilterProperties(PropertyDescriptorCollection properties)
        {
            ...
            foreach (PropertyDescriptor property in properties)
            {
                ...
                switch (propId)
                {
                    ...
                    case CyEPropertyIdEnum.NumberOfDataElementsToTransferX:
                    ...
                    case CyEPropertyIdEnum.DestinationIncrementEveryCycleByX:
                        ...
                        break;
                    case CyEPropertyIdEnum.NumberOfDataElementsToTransferY:
                        break;
        ...
        protected override CyRange GetPropertyRange(CyEPropertyIdEnum propId)
        {
            switch (propId)
            {
                ...
                case CyEPropertyIdEnum.ChannelStateOnCompletion:
                    return null;
                case CyEPropertyIdEnum.NumberOfDataElementsToTransferX:
                    return CyConst.R_NUMBER_OF_DATA_ELEMENTS_TO_TRANSFER_X;
                case CyEPropertyIdEnum.SourceIncrementEveryCycleByX:
                    return CyConst.R_SOURCE_INCREMENT_EVERY_CYCLE_BY_X;
                case CyEPropertyIdEnum.DestinationIncrementEveryCycleByX:
                    return CyConst.R_DESTINATION_INCREMENT_EVERY_CYCLE_BY_X;
                case CyEPropertyIdEnum.NumberOfDataElementsToTransferY:
                    return CyConst.R_NUMBER_OF_DATA_ELEMENTS_TO_TRANSFER_Y;
                case CyEPropertyIdEnum.SourceIncrementEveryCycleByY:

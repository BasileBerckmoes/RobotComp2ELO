...
#define `$INSTANCE_NAME`_INITIAL_DATE_HOUR_MODE    (0u)
...
__STATIC_INLINE cy_en_rtc_status_t `$INSTANCE_NAME`_SetAlarmDateAndTimeDirect(uint32_t sec, uint32_t min, 
                                                                              ...
                                                                              uint32_t month, uint32_t alarmIndex);
__STATIC_INLINE uint32_t `$INSTANCE_NAME`_GetHoursFormat(void);
__STATIC_INLINE cy_en_rtc_status_t `$INSTANCE_NAME`_SetHoursFormat(uint32_t hourMode);
...
__STATIC_INLINE void `$INSTANCE_NAME`_SetInterruptMask(uint32_t interruptMask);
    ...
    ****************************************************************************//**
    *
    * Declaration of RTC driver Alarm_1 interrupt handler function.
    *
    * The RTC driver Cy_RTC_Alarm1Interrupt() function is a blank weak interrupt 
    * handler function which indicates assert of the RTC alarm 1 interrupt.
    * 
    ...
    ****************************************************************************//**
    *
    * Declaration of RTC driver Alarm_2 interrupt handler function.
    *
    * The RTC driver Cy_RTC_Alarm2Interrupt() function is a blank weak interrupt 
    * handler function which indicates assert of the RTC alarm 2 interrupt.
    * 
    * Function implementation should be defined in user source code in condition 
    * that such event handler is required. If such event is not required user 
    * should not do any actions.
    ...
    ****************************************************************************//**
    *
    * Declaration of RTC driver interrupt handler Cy_RTC_CenturyInterrupt() 
    * function.
    *
    * The RTC driver Cy_RTC_CenturyInterrupt() function is a blank weak interrupt 
    * handler function which indicates the year reached 2100.
    * 
    * Function implementation should be defined in user source code in condition 
    * that such event handler is required. If such event is not required user 
    * should not do any actions.
    ...
    *******************************************************************************/
    void Cy_RTC_CenturyInterrupt(void);
        ...
        __STATIC_INLINE cy_en_rtc_status_t `$INSTANCE_NAME`_EnableDstTime(cy_stc_rtc_dst_t const *dstTime, cy_stc_rtc_config_t *timeDate);
        __STATIC_INLINE cy_en_rtc_status_t `$INSTANCE_NAME`_SetNextDstTime(cy_stc_rtc_dst_format_t const *nextDst);
        __STATIC_INLINE bool `$INSTANCE_NAME`_GetDstStatus(cy_stc_rtc_dst_t const *dstTime, cy_stc_rtc_config_t *timeDate);
    #endif /* (0u != `$INSTANCE_NAME`_INITIAL_DST_STATUS) */
#endif /* (0u != `$INSTANCE_NAME`_INITIAL_IRQ_STATUS) */
...
__STATIC_INLINE cy_en_rtc_status_t `$INSTANCE_NAME`_SetAlarmDateAndTimeDirect(uint32_t sec, uint32_t min, uint32_t hour,
                                                                              uint32_t date, uint32_t month,
                                                                              uint32_t alarmIndex)
{

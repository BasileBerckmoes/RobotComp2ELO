...
using SCB_I2C_PDL_v1_0.Controls;

namespace SCB_I2C_PDL_v1_0
{
        ...
        ICyAPICustomize_v1
    {
        ...
        private double GetTolerance(CyEModeType mode, double clkMin, double clkMax)
        {
            ...
            {
                // Take into account max IMO accuracy
                clkMin *= (1 + CyRanges.CyTolerance.IMO_ACCURACY / 100);
            ...
            else
            {
                ...
                tolerance = (double)((clkMax / clkMin) * 100) - CyRanges.CyTolerance.IMO_ACCURACY;
            }
            ...
            ICyExprTypeConverter typeConverter)
        {
            if (args.Length == GET_FUNC_ARG_LENGTH)
            {
                try
                {
                    ...
                    double tolerance = (mode == CyEModeType.SLAVE) ?
                                           CyRanges.CyTolerance.ZERO_ACCURACY : 
            ...
            return CyRanges.CyTolerance.IMO_ACCURACY;
        }

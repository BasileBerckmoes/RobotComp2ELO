...
#define `$INSTANCE_NAME`_ENABLE_SLAVE       (0UL != (`$INSTANCE_NAME`_MODE & CY_SCB_I2C_SLAVE))
#define `$INSTANCE_NAME`_ENABLE_MASTER      (0UL != (`$INSTANCE_NAME`_MODE & CY_SCB_I2C_MASTER))
#define `$INSTANCE_NAME`_MANUAL_SCL_CONTROL (0UL != `$EnableManualSclControl`UL)
...
__STATIC_INLINE uint32_t `$INSTANCE_NAME`_SetDataRate(uint32_t dataRateHz, uint32_t scbClockkHz);
__STATIC_INLINE uint32_t `$INSTANCE_NAME`_GetDataRate(uint32_t scbClockkHz);

/* Register callbacks. */
__STATIC_INLINE void `$INSTANCE_NAME`_RegisterEventCallback(scb_i2c_handle_events_t callback);
#if (`$INSTANCE_NAME`_ENABLE_SLAVE)
__STATIC_INLINE void `$INSTANCE_NAME`_RegisterAddrCallback (scb_i2c_handle_addr_t callback);
...
__STATIC_INLINE void     `$INSTANCE_NAME`_SlaveConfigReadBuf(uint8_t *rdBuf, uint32_t size);
...
__STATIC_INLINE void     `$INSTANCE_NAME`_SlaveConfigWriteBuf(uint8_t *wrBuf, uint32_t size);
...
__STATIC_INLINE cy_en_scb_i2c_status_t `$INSTANCE_NAME`_MasterRead(cy_stc_scb_i2c_master_xfer_config_t *masterXferConfig);
__STATIC_INLINE void `$INSTANCE_NAME`_MasterAbortRead(void);
__STATIC_INLINE cy_en_scb_i2c_status_t `$INSTANCE_NAME`_MasterWrite(cy_stc_scb_i2c_master_xfer_config_t *masterXferConfig);
...
__STATIC_INLINE cy_en_scb_i2c_status_t `$INSTANCE_NAME`_MasterSendStart(uint32_t address, uint32_t bitRnW, uint32_t timeoutMs);
__STATIC_INLINE cy_en_scb_i2c_status_t `$INSTANCE_NAME`_MasterSendReStart(uint32_t address, uint32_t bitRnW, uint32_t timeoutMs);
__STATIC_INLINE cy_en_scb_i2c_status_t `$INSTANCE_NAME`_MasterSendStop(uint32_t timeoutMs);
__STATIC_INLINE cy_en_scb_i2c_status_t `$INSTANCE_NAME`_MasterReadByte(uint32_t ackNack, uint8_t *byte, uint32_t timeoutMs);
__STATIC_INLINE cy_en_scb_i2c_status_t `$INSTANCE_NAME`_MasterWriteByte(uint32_t theByte, uint32_t timeoutMs);
#endif /* (`$INSTANCE_NAME`_ENABLE_MASTER) */
...
__STATIC_INLINE void `$INSTANCE_NAME`_SlaveConfigReadBuf(uint8_t *rdBuf, uint32_t size)
{
    Cy_SCB_I2C_SlaveConfigReadBuf(`$INSTANCE_NAME`_HW, rdBuf, size, &`$INSTANCE_NAME`_context);
}
...
__STATIC_INLINE void `$INSTANCE_NAME`_SlaveConfigWriteBuf(uint8_t *wrBuf, uint32_t size)
{
    Cy_SCB_I2C_SlaveConfigWriteBuf(`$INSTANCE_NAME`_HW, wrBuf, size, &`$INSTANCE_NAME`_context);
}
...
__STATIC_INLINE cy_en_scb_i2c_status_t `$INSTANCE_NAME`_MasterRead(cy_stc_scb_i2c_master_xfer_config_t *masterXferConfig)
{
    return Cy_SCB_I2C_MasterRead(`$INSTANCE_NAME`_HW, masterXferConfig, &`$INSTANCE_NAME`_context);
}
...
__STATIC_INLINE cy_en_scb_i2c_status_t `$INSTANCE_NAME`_MasterWrite(cy_stc_scb_i2c_master_xfer_config_t *masterXferConfig)
{
    return Cy_SCB_I2C_MasterWrite(`$INSTANCE_NAME`_HW, masterXferConfig, &`$INSTANCE_NAME`_context);
}
...
__STATIC_INLINE cy_en_scb_i2c_status_t `$INSTANCE_NAME`_MasterWriteByte(uint32_t theByte, uint32_t timeoutMs)
{
    return Cy_SCB_I2C_MasterWriteByte(`$INSTANCE_NAME`_HW, theByte, timeoutMs, &`$INSTANCE_NAME`_context);
}
#endif /* (`$INSTANCE_NAME`_ENABLE_MASTER) */

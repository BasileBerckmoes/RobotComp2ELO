...
namespace PowerMonitor_P4_v1_0
{
    public partial class CyGeneralTab : CyEditingWrapperControl
    {
        ...
        private void m_cbVrefDisplay_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            m_params.AdcClkDivider = CyClock.GetAdcClockDivider(m_params);
        }
        ...
        public void m_lblRefreshTime_Update(object sender, EventArgs e)
        {
            ...
            //m_lblRefreshTime.Text = string.Format(refresh_template, (m_params.AdcScanTime / 1000.0));
            ...
            if (m_params.EnableDMA)
            {
                ...
                //m_lblRspTime.Text = string.Format(response_template, (m_params.RspTime / 1000.0));

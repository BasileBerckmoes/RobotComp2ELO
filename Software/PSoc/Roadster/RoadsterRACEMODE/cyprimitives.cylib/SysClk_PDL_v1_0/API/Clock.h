...
{
    Cy_SysClk_PeriphEnableDivider(`$INSTANCE_NAME`_DIV_TYPE, `$INSTANCE_NAME`_DIV_NUM);
}
...
{
    Cy_SysClk_PeriphDisableDivider(`$INSTANCE_NAME`_DIV_TYPE, `$INSTANCE_NAME`_DIV_NUM);
}
...
{
    Cy_SysClk_PeriphSetDivider(`$INSTANCE_NAME`_DIV_TYPE, `$INSTANCE_NAME`_DIV_NUM, dividerValue);
}
...
{
    Cy_SysClk_PeriphSetFracDivider(`$INSTANCE_NAME`_DIV_TYPE, `$INSTANCE_NAME`_DIV_NUM, dividerIntValue, dividerFracValue);
}

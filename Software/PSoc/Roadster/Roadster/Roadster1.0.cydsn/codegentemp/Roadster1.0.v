...
// ADC_SAR_v3_10(ADC_Clock=0, ADC_Clock_Frequency=7578948, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=0, ADC_Resolution=8, ADC_SampleMode=0, Enable_next_out=true, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=true, Sample_Precharge=4, Sample_Rate=0, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_IR:SAR, CY_INSTANCE_SHORT_NAME=SAR, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=ADC_IR_SAR, )
...
// ADC_SAR_SEQ_v2_10(ADC_Clock_Frequency=1000008, Adjust=1, ClockSource=0, InputRange=1, NumChannels=8, Reference=0, Resolution=8, rm_int=false, SampleMode=0, SamplePrecharge=4, SampleRate=83334, SampleRate_def=631579, VrefValue=2.5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_SEQ_v2_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_IR, CY_INSTANCE_SHORT_NAME=ADC_IR, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=ADC_IR, )
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=208, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=2, Voltage=3328, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=BleVDAC, CY_INSTANCE_SHORT_NAME=BleVDAC, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=BleVDAC, )
...
// OpAmp_v1_90(Mode=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=BleBuffer, CY_INSTANCE_SHORT_NAME=BleBuffer, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=BleBuffer, )
...
module top ;
    ...
    begin : demux_1
        ...
        assign Net_656 = tmp__demux_1_3_reg;
    end
    // -- De Mux end --
    ...
    begin : mux_1
        ...
        begin
            case (selectUltraS[0:1])
                2'b00 :  tmp__mux_1_reg = 1'b0;
                2'b01 :  tmp__mux_1_reg = 1'b0;
    ...
    CyStatusReg_v1_90 statusEcho (
        ...
        .intr(Net_646),
        .status_bus(8'b0));
    defparam statusEcho.Bit0Mode = 0;
    defparam statusEcho.Bit1Mode = 0;
    defparam statusEcho.Bit2Mode = 0;
    defparam statusEcho.Bit3Mode = 0;
    defparam statusEcho.Bit4Mode = 0;
    defparam statusEcho.Bit5Mode = 0;
    defparam statusEcho.Bit6Mode = 0;
    defparam statusEcho.Bit7Mode = 0;
    defparam statusEcho.BusDisplay = 0;
    defparam statusEcho.Interrupt = 0;
    defparam statusEcho.MaskValue = 0;
    defparam statusEcho.NumInputs = 1;
    ...
    OpAmp_v1_90_6 BleBuffer (
        .Vplus(Net_705),
        .Vout(Net_812),
        .Vminus(Net_728));
    defparam BleBuffer.Mode = 1;

    UART_v2_50_7 BleUart (
        .cts_n(1'b0),
        .tx(Net_780),
        .rts_n(Net_781),
        .tx_en(Net_782),
    ...
    Timer_v2_80_8 sendBleDataTimer (
        .reset(Net_12),
        .interrupt(Net_1139),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_1143),
        .tc(Net_1144),
        .clock(Net_10));
    ...
    begin : demux_2
        ...
        always @(Net_691 or Net_1168)
        begin
            case (Net_1168)
                1'b0:
                begin
                    tmp__demux_2_0_reg = Net_691;
                    tmp__demux_2_1_reg = 1'b0;
                end
                1'b1:
                begin
                    tmp__demux_2_0_reg = 1'b0;
                    tmp__demux_2_1_reg = Net_691;
                end
            endcase
        end
        assign Net_1148 = tmp__demux_2_0_reg;
        assign Net_1149 = tmp__demux_2_1_reg;
    end
    // -- De Mux end --
    ...
    begin : demux_3
        ...
        always @(Net_690 or Net_1168)
        begin
            case (Net_1168)
                1'b0:
                begin
                    tmp__demux_3_0_reg = Net_690;
                    tmp__demux_3_1_reg = 1'b0;
                end
                1'b1:
                begin
                    tmp__demux_3_0_reg = 1'b0;
                    tmp__demux_3_1_reg = Net_690;
                end
            endcase
        end
        assign Net_1160 = tmp__demux_3_0_reg;
        assign Net_1161 = tmp__demux_3_1_reg;
    end
    // -- De Mux end --

	wire [0:0] tmpOE__Richting_net;
	wire [0:0] tmpIO_0__Richting_net;
	wire [0:0] tmpINTERRUPT_0__Richting_net;
	electrical [0:0] tmpSIOVREF__Richting_net;

	cy_psoc3_pins_v1_10
		#(.id("a1fb15ec-3693-4325-9500-19b351f254ef"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Richting
		 (.oe(tmpOE__Richting_net),
		  .y({1'b0}),
		  .fb({Net_1168}),
		  .io({tmpIO_0__Richting_net[0:0]}),
		  .siovref(tmpSIOVREF__Richting_net),
		  .interrupt({tmpINTERRUPT_0__Richting_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Richting_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

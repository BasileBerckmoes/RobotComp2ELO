...
#define BS_IOPINS1_7_VAL ((const uint8 CYFAR *)0x4800092Cu)
...
#define BS_PHUB_CFGMEM1_VAL ((const uint8 CYFAR *)0x48000950u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT5_AMUX, 0x0101u);

...
namespace DMA_PDL_v1_0.Utils
{
    public static class CyTextConst
    {
        ...
        public const string CY_DMA_TXFR_SIZE_DATA_SIZE = "CY_DMA_TXFR_SIZE_DATA_SIZE";
        public const string CY_DMA_TXFR_SIZE_WORD = "CY_DMA_TXFR_SIZE_WORD";
        #endregion
        ...
        public const string DESCRIPTION_NUMBER_OF_DATA_ELEMENTS_TO_TRANSFER =
            "This parameter is available for both the X loop setting and Y loop setting. This parameter configures how many transfers are effected in the X/Y loops.";
        ...
        public const string RetriggerAfter4Sysclkcycles = "Retrigger after 4 SYSCLK cycles";
        public const string RetriggerAfter16SysclkCycles = "Retrigger after 16 SYSCLK cycles";

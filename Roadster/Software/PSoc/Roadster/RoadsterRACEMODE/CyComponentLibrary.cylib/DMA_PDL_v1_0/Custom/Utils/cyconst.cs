...
namespace DMA_PDL_v1_0.Utils
{
    public static class CyConst
    {
        ...
        public static readonly CyRange R_NUMBER_OF_DATA_ELEMENTS_TO_TRANSFER_X =
            new CyRange(C_CATEGORY_LOOP_TRANSFER_UINT16_DEF, 0, 255);
        ...
        public static readonly CyRange R_DESTINATION_INCREMENT_EVERY_CYCLE_BY_X =
            new CyRange(C_CATEGORY_LOOP_TRANSFER_DEF, -2048, 2047);
        public static readonly CyRange R_NUMBER_OF_DATA_ELEMENTS_TO_TRANSFER_Y =
            new CyRange(C_CATEGORY_LOOP_TRANSFER_UINT16_DEF, 0, 255);

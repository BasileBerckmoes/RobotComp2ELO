...
#define `$INSTANCE_NAME`_ENABLE_SECOND_ADDR  (`$NumOfAddr`UL != 0UL)
...
__STATIC_INLINE void     `$INSTANCE_NAME`_SetBuffer1(uint8_t* buf, uint32_t bufSize, uint32_t rwBoundary);
...
__STATIC_INLINE void     `$INSTANCE_NAME`_SetBuffer2(uint8_t* buf, uint32_t bufSize, uint32_t rwBoundary);
...
__STATIC_INLINE void `$INSTANCE_NAME`_SetBuffer1(uint8_t* buf, uint32_t bufSize, uint32_t rwBoundary)
{
    Cy_SCB_EZI2C_SetBuffer1(`$INSTANCE_NAME`_HW, buf, bufSize, rwBoundary, &`$INSTANCE_NAME`_context);
}
...
__STATIC_INLINE void `$INSTANCE_NAME`_SetBuffer2(uint8_t* buf, uint32_t bufSize, uint32_t rwBoundary)
{
    Cy_SCB_EZI2C_SetBuffer2(`$INSTANCE_NAME`_HW, buf, bufSize, rwBoundary, &`$INSTANCE_NAME`_context);
}
#endif /* (`$INSTANCE_NAME`_ENABLE_SECOND_ADDR) */

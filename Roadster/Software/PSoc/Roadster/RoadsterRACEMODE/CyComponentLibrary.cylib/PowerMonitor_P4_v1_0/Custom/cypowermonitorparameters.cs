...
namespace PowerMonitor_P4_v1_0
{
    ...
    public class CyParameters
    {
        ...
        public int Hclk_Hz = 0;
        public int SysClk_Hz = 0;
        public int AdcClkDivider = 0;
        ...
        public CyParameters(ICyInstQuery_v1 inst)
        {
            ...
            Hclk_Hz = CyClock.GetHclk(inst);
            SysClk_Hz = CyClock.GetSysClk(inst);
            AdcClkDivider = CyClock.GetAdcClockDivider(this);

...
/* Register callback. */
__STATIC_INLINE void `$INSTANCE_NAME`_RegisterCallback(scb_uart_handle_events_t callback);
...
__STATIC_INLINE void     `$INSTANCE_NAME`_SetRtsFifoLevel(uint32_t rxFifoLevel);
...
__STATIC_INLINE uint32_t `$INSTANCE_NAME`_GetArray(void *rxBuf, uint32_t size);
__STATIC_INLINE void     `$INSTANCE_NAME`_GetArrayBlocking(void *rxBuf, uint32_t size);
...
__STATIC_INLINE uint32_t `$INSTANCE_NAME`_PutArray(void *txBuf, uint32_t size);
__STATIC_INLINE void     `$INSTANCE_NAME`_PutArrayBlocking(void *txBuf, uint32_t size);
__STATIC_INLINE void     `$INSTANCE_NAME`_PutString(char string[]);
...
__STATIC_INLINE void     `$INSTANCE_NAME`_StartRingBuffer(void *ringBuffer, uint32_t size);
...
__STATIC_INLINE cy_en_scb_uart_status_t `$INSTANCE_NAME`_Receive(void *rxBuf, uint32_t size);
...
__STATIC_INLINE cy_en_scb_uart_status_t `$INSTANCE_NAME`_Transmit(void *txBuf, uint32_t size);
...
__STATIC_INLINE void `$INSTANCE_NAME`_SetRtsFifoLevel(uint32_t rxFifoLevel)
{
    Cy_SCB_UART_SetRtsFifoLevel(`$INSTANCE_NAME`_HW, rxFifoLevel);
}
...
__STATIC_INLINE uint32_t `$INSTANCE_NAME`_GetArray(void *rxBuf, uint32_t size)
{
    return Cy_SCB_UART_GetArray(`$INSTANCE_NAME`_HW, rxBuf, size);
}
...
__STATIC_INLINE void `$INSTANCE_NAME`_GetArrayBlocking(void *rxBuf, uint32_t size)
{
    Cy_SCB_UART_GetArrayBlocking(`$INSTANCE_NAME`_HW, rxBuf, size);
}
...
__STATIC_INLINE uint32_t `$INSTANCE_NAME`_PutArray(void *txBuf, uint32_t size)
{
    return Cy_SCB_UART_PutArray(`$INSTANCE_NAME`_HW, txBuf, size);
}
...
__STATIC_INLINE void `$INSTANCE_NAME`_PutArrayBlocking(void *txBuf, uint32_t size)
{
    Cy_SCB_UART_PutArrayBlocking(`$INSTANCE_NAME`_HW, txBuf, size);
}
...
__STATIC_INLINE void `$INSTANCE_NAME`_StartRingBuffer(void *ringBuffer, uint32_t size)
{
    Cy_SCB_UART_StartRingBuffer(`$INSTANCE_NAME`_HW, ringBuffer, size, &`$INSTANCE_NAME`_context);
}
...
__STATIC_INLINE cy_en_scb_uart_status_t `$INSTANCE_NAME`_Receive(void *rxBuf, uint32_t size)
{
    return Cy_SCB_UART_Receive(`$INSTANCE_NAME`_HW, rxBuf, size, &`$INSTANCE_NAME`_context);
}
...
__STATIC_INLINE cy_en_scb_uart_status_t `$INSTANCE_NAME`_Transmit(void *txBuf, uint32_t size)
{
    return Cy_SCB_UART_Transmit(`$INSTANCE_NAME`_HW, txBuf, size, &`$INSTANCE_NAME`_context);
}

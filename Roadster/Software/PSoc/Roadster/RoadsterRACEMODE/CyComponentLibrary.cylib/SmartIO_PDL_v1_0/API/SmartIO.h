...
*******************************************************************************/
__STATIC_INLINE uint8 `$INSTANCE_NAME`_GetBypass(void)
{
    return ((uint8)(`$INSTANCE_NAME`_PORT->CTL & ((uint32_t)`$INSTANCE_NAME`_CHANNEL_ALL << SMARTIO_PRT_CTL_BYPASS_Pos)));
}

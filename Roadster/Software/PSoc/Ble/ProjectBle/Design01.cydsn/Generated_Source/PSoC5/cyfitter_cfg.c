...
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x48000B10u)
...
#define BS_IOPINS1_7_VAL ((const uint8 CYFAR *)0x48000B30u)
...
#define BS_PHUB_CFGMEM1_VAL ((const uint8 CYFAR *)0x48000B4Cu)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG3_CFG0), 0x013Fu);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SAR0_SW0, 0x60u);
